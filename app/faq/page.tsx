...
const graph = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "BreadcrumbList",
      "@id":
        "https://www.bindarchitects.com/faq?page&pagename=faq/#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
    ...
    },
    {
      "@type": "FAQPage",
      "@id":
        "https://www.bindarchitects.com/faq/#schema-webpage",
      isPartOf: "https://www.bindarchitects.com/#schema-website",
      mainEntity: {
        "@type": "WebPage",
        "@id":
          "https://www.bindarchitects.com/faq/#schema-webpage-main-entity",
        url: "https://www.bindarchitects.com/faq/",
        headline: "Frequently Asked Questions - Bind",
        description:
          "Find answers to common questions about Bind and our services.",
      ...
      hasPart: [
        {
          ...
          "@id":
            "https://www.bindarchitects.com/faq/#schema-nav-element-529",
          name: "Home",
          url: "https://www.bindarchitects.com/",
        },
        {
          "@type": "SiteNavigationElement",
          "@id":
            "https://www.bindarchitects.com/faq/#schema-nav-element-528",
          name: "",
        ...
        },
        {
          "@type": "SiteNavigationElement",
          "@id":
            "https://www.bindarchitects.com/faq/#schema-nav-element-527",
          name: "",
        ...
        },
        {
          "@type": "SiteNavigationElement",
          "@id":
            "https://www.bindarchitects.com/faq/#schema-nav-element-525",
          name: "",
          url: "https://www.bindarchitects.com/faq/",
        },
        {
      ...
      image: {
        "@type": "ImageObject",
        "@id":
          "https://www.bindarchitects.com/faq/#schema-article-image",
        url: "https://firebasestorage.googleapis.com/v0/b/bind-f87fe.appspot.com/o/logo.png?alt=media&token=5a778e05-4ce8-4b61-ae5d-b6ec3e3e359d",
        height: 153,
        width: 300,
        caption: "design lab for engineering and architecture bind logo",
  ...
  return (
    <div>
      ...
      <Head>
        <link
          rel="canonical"
          href="https://www.bindarchitects.com/faq/"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.bindarchitects.com/faq/"
        />
        <meta name="twitter:card" content="summary" />
        <meta
          name="twitter:title"
          content="FAQ - Bind Architects"
        />
        <meta
