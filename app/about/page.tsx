...
export const metadata: Metadata = {
  ...
  description:
    "Discover the vision and expertise of Studio Bind Architects in crafting innovative and sustainable designs. Learn more about our team and commitment to architectural excellence.",
};
