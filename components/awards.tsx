...
export function Awards() {
  return (
    <div className="">
      <section
        className="container mx-auto  items-center text-center bg-slate-50 mb-20 animate-fade-right dark:bg-transparent md:py-6"
        ...
        <div className="md:max-w-[58rem] md:grid-cols-1">
          <div className="flex md:flex-col flex-col">
            ...
            <div className="flex-1 text-xl dmsans2 leading-normal dmsans text-left text-muted-foreground sm:text-md sm:leading-8">
              STUDIO BIND - National Architecture and Interior Design Excellence
