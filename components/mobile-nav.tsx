...
export function MobileNav({ items, children }: MobileNavProps) {
  ...
  return (
    <div
      className={cn(
        "slide-in-from-right transition-tranformation duration-350  max-w-full  min-h-screen fixed inset-0 top-16 z-50 grid  grid-flow-row auto-rows-max overflow-auto  pb-32 shadow-md animate-in md:hidden"
      )}
    >
