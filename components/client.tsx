  ...
  return (
    <div className="text-center items-center p-6 mx-auto mb-20  justify-center md:max-w-[78rem] max-w-[28rem]">
      <h1
        ...
        className="2xl:text-6xl text-center mx-auto  justify-center  mt-28 title-gradient font-heading flex flex-wrap md:max-w-[78rem] max-w-[28rem]  z-30 text-5xl lg:text-7xl md:text-6xl xl:text-8xl title-gradient    duration-1000  cursor-default text-edge-outline animate-title font-display"
      >
        Selected Clients
      </h1>
      ...
      <h1
            aria-label="Studio bind"
            className="text-muted-foreground my-font text-lg mt-6"
          >
        ...
        designs are 
          ...
          <h1
            aria-label="Studio bind"
            className=" md:inline-block sm:hidden text-muted-foreground my-font text-lg "
          >
           unique, useful and user-friendly
          </h1>
