      ...
      <div className="relative overflow-hidden rounded-lg border  border-r-blue-400 border-t-green-400 border-s-orange-400 border-b-purple-400 bg-background p-2 mx-auto grid justify-center  gap-4 sm:grid-cols-2 md:max-w-[75rem] md:grid-cols-1">
        <div className="flex  flex-col justify-between rounded-md p-6">
          <div className="  mt-1 text-center mx-auto d-block">
            <p className="md:text-5xl text-4xl font-heading font-semibold text-gradient" aria-label="Still have questions">
              Any questions ?
            </p>
            <LightBox className=" md:mt-5 mt-5 md:w-80 w-60 mx-auto justify-center" />
            <p className=" md:text-lg dmsans text-md max-w-[50rem] text-teal-400 text-center mt-5  mb-5  font-semibold">
