    ...
    return (
      <Accordion type="single" collapsible className="mx-auto mb-14 d-block md:max-w-4xl w-2/3 mt-10">
        <AccordionItem value="item-1">
          <AccordionTrigger className="mb-3 md:ml-0 ml-5 font-heading text-zinc-300">What services do you offer?</AccordionTrigger>
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger className="mb-3 font-heading text-zinc-300">How do I start a project with your team?</AccordionTrigger>
          <AccordionContent className="text-muted-foreground ">
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger className="mb-3 font-heading text-zinc-300">What is the typical timeline for a project?</AccordionTrigger>
          <AccordionContent className="text-muted-foreground">
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger className="mb-3 font-heading text-zinc-300">Can you help with both new construction and renovations?</AccordionTrigger>
          <AccordionContent className="text-muted-foreground">
        ...
        <AccordionItem value="item-5">
          <AccordionTrigger className="mb-3 font-heading text-zinc-300">How do you ensure the design aligns with my preferences?</AccordionTrigger>
          <AccordionContent className="text-muted-foreground">
        ...
        <AccordionItem value="item-6">
          <AccordionTrigger className="mb-3 font-heading text-zinc-300">Will you work within my budget?</AccordionTrigger>
          <AccordionContent className="text-muted-foreground">
        ...
        <AccordionItem value="item-7">
          <AccordionTrigger className="mb-3 font-heading text-zinc-300">Do you handle project permits and regulations?</AccordionTrigger>
          <AccordionContent className="text-muted-foreground">
        ...
        <AccordionItem value="item-8">
          <AccordionTrigger className="mb-3 font-heading text-zinc-300">Can you recommend reliable contractors and suppliers?</AccordionTrigger>
          <AccordionContent className="text-muted-foreground">
        ...
        <AccordionItem value="item-9">
          <AccordionTrigger className="mb-3 font-heading text-zinc-300">Will I have access to design progress updates?</AccordionTrigger>
          <AccordionContent className="text-muted-foreground">
        ...
        <AccordionItem value="item-10">
          <AccordionTrigger className="mb-3 font-heading text-zinc-300">What sets your firm apart from others?</AccordionTrigger>
          <AccordionContent className="text-muted-foreground">
        ...
        <AccordionItem value="item-6">
          <AccordionTrigger className="mb-3 md:ml-0 ml-6 font-heading text-zinc-300">Where are you located?</AccordionTrigger>
          <AccordionContent className="text-muted-foreground">
